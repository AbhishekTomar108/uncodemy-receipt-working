...
export default function AddRegisteredStudent
 ...
 console.log('delete student func')

    ContextValue.updateProgress(30)
    ContextValue.updateBarStatus(true)
    
    try {
      const res = await fetch('http://localhost:8000/deleteRegisterStudent', {
        method: 'POST',
        headers: {
          "Content-Type": "application/json",
        },
      ...
      const googleSheetResponse = await fetch(
        "http://localhost:8000/delete-google-sheet",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
      ...
      <div className="content-body">
        <div className="container-fluid">
          <div className="row page-titles mx-0">
           ...
           {deleteStatus===true && <div className="delete-icon">
            <i class="fa-solid fa-trash" onClick={deleteStudent}/>
            </div>}
